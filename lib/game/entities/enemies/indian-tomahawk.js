ig.module(
    'game.entities.enemies.indian-tomahawk'
)
.requires(
    'impact.entity',
    'impact.entity-pool',
...
.defines(function() {
    EntityIndianTomahawk = EntitySoldier.extend({
        
        animSheet: new ig.AnimationSheet( 'media/indian-tomahawk.png', 16, 16 ),
    ...
    ig.EntityPool.enableFor( EntityIndianTomahawk );
});