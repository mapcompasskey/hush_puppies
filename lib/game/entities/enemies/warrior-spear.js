...
.defines(function() {
    EntityWarriorSpear = EntityShooterBullet.extend({
        
        offset: {x: 5, y: 2},
        animSheet: new ig.AnimationSheet( 'media/enemies/warrior-spear.png', 13, 7 ),
    ...
    ig.EntityPool.enableFor( EntityWarriorSpear );
});