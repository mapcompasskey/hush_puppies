...
.defines(function() {
    EntityPlayer = ig.Entity.extend({
        ...
        init: function( x, y, settings ) {
            ...
            // add the animations
            this.addAnim( 'idleE', 1, [0], true );
            this.addAnim( 'walkE', 0.2, [1, 2] );
            this.addAnim( 'idleSE', 1, [3], true );
            this.addAnim( 'walkSE', 0.2, [4, 5] );
            this.addAnim( 'idleS', 1, [6], true );
            this.addAnim( 'walkS', 0.2, [7, 8] );
            this.addAnim( 'idleSW', 1, [9], true );
            this.addAnim( 'walkSW', 0.2, [10, 11] );
            this.addAnim( 'idleW', 1, [12], true );
            this.addAnim( 'walkW', 0.2, [13, 14] );
            this.addAnim( 'idleNW', 1, [15], true );
            this.addAnim( 'walkNW', 0.2, [16, 17] );
            this.addAnim( 'idleN', 1, [18], true );
            this.addAnim( 'walkN', 0.2, [19, 20] );
            this.addAnim( 'idleNE', 1, [21], true );
