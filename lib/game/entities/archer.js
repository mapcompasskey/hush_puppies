...
.defines(function() {
    EntityArcher = ig.Entity.extend({
        ...
        init: function( x, y, settings ) {
            ...
            this.addAnim( 'hurt', 0.1, [5, 5, 5] );
            this.addAnim( 'dead', 0.1, [5, 6, 6] );
            this.prepareEntity();
        },
        ...
        isAttacking: function() {
            ...
            // if attacking, reset the timer when the animation ends
            if ( this.canAttack ) {
        ...
        // called by EnitityGiantCrab during check() collision
        /*damageGiantCrab: function() {
            if ( this.hurting || this.dying ) {
                return false;
            }
