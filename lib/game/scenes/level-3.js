...
.defines(function() {
    ...
    Level3 = ig.Game.extend({
        ...
        loadLevel: function() {
            ...
            // add skyline
            ig.game.spawnEntity( EntitySkyline, 0, 0, {skyline: 3} );
        ...
        updateEnemeyStrength: function() {
            ...
            if ( strength <= 0 ) {
                strength = 0;
                ig.global.levelsComplete.level_3 = true;
        ...
        addEnemyDinosaur: function() {
            ...
            // spawn new enemy
            ig.game.spawnEntity( EntityDinosaur, xPos, yPos );
        },
        
        // add Caveman
        addEnemyCaveman: function() {
            ...
            // spawn new enemy
            ig.game.spawnEntity( EntityCaveman, xPos, yPos );
        },
