...
.defines(function() {
    ...
    Level4 = ig.Game.extend({
        ...
        loadLevel: function() {
            ...
            // add skyline
            ig.game.spawnEntity( EntitySkyline, 0, 0, {skyline: 4} );
        ...
        updateEnemeyStrength: function() {
            ...
            if ( strength <= 0 ) {
                strength = 0;
                ig.global.levelsComplete.level_4 = true;
        ...
        addEnemyShooter: function() {
            ...
            // spawn new enemy
            ig.game.spawnEntity( EntityOutlaw, xPos, yPos );
        },
        ...
        addEnemySoldier: function() {
            ...
            // spawn new enemy
            ig.game.spawnEntity( EntityBandit, xPos, yPos );
        },
