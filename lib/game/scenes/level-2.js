...
.requires(
    'impact.game',
    'game.entities.hoplite',
    'game.entities.slinger'
)
.defines(function() {
    ...
    Level2 = ig.Game.extend({
        ...
        loadLevel: function() {
            ...
            // add skyline
            ig.game.spawnEntity( EntitySkyline, 0, 0, {skyline:2} );
        ...
        updateEnemeyStrength: function() {
            ...
            if ( strength <= 0 ) {
                strength = 0;
                ig.global.levelsComplete.level_2 = true;
        ...
        addEnemySlinger: function() {
            ...
            // spawn new enemy
            ig.game.spawnEntity( EntitySlinger, xPos, yPos );
        },
        
        // add Hoplite
        addEnemyHoplite: function() {
            ...
            // spawn new enemy
            ig.game.spawnEntity( EntityHoplite, xPos, yPos );
        },
