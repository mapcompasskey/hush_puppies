...
.defines(function() {
    ...
    ScreenAbout = ig.Game.extend({
        ...
        getAboutText: function() {
            ...
            */
            var str =
            'CODE NAME: Hush Puppies' + 
            '\n\n' +
            '"a shooting game where you time travel with giant crabs before the apocalypse"' +
            '\n\n' +
            'The time of man has reached its end. ' + 
            'Travel through time, collecting together the Giant Crab\'s who when gathered in one place will bring about the apocalypse. ' + 
            '\n\n' +
            'CONTROLS: ' + '\n' +
            'WASD keys to move ' + '\n' +
            ...
            '\n\n' +
            'Game Idea Generator:' + '\n' +
            'The idea for this game was randomly generated by the following website: ' + '\n' + 
